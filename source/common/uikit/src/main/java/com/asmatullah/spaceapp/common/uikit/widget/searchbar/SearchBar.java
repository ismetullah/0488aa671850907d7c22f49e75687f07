package com.asmatullah.spaceapp.common.uikit.widget.searchbar;
...
import com.asmatullah.spaceapp.common.uikit.widget.searchbar.adapter.DefaultSuggestionsAdapter;
...
public class SearchBar extends FrameLayout implements View.OnClickListener,
    ...
    private void init(AttributeSet attrs) {
        ...
        //Base Attributes
        speechMode = array.getBoolean(R.styleable.SearchBar_mt_speechMode, false);
        maxSuggestionCount = array.getInt(R.styleable.SearchBar_mt_maxSuggestionsCount, 3);
        navButtonEnabled = array.getBoolean(R.styleable.SearchBar_mt_navIconEnabled, false);
        roundedSearchBarEnabled = array.getBoolean(R.styleable.SearchBar_mt_roundedSearchBarEnabled, false);
        dividerColor = array.getColor(R.styleable.SearchBar_mt_dividerColor, ContextCompat.getColor(getContext(), R.color.searchBarDividerColor));
        ...
        menuIconRes = array.getResourceId(R.styleable.SearchBar_mt_menuIconDrawable, R.drawable.ic_dots_vertical_black_48dp);
        searchIconRes = array.getResourceId(R.styleable.SearchBar_mt_searchIconDrawable, R.drawable.ic_magnify_black_48dp);
        speechIconRes = array.getResourceId(R.styleable.SearchBar_mt_speechIconDrawable, R.drawable.ic_microphone_black_48dp);
        arrowIconRes = array.getResourceId(R.styleable.SearchBar_mt_backIconDrawable, R.drawable.ic_arrow_left_black_48dp);
        clearIconRes = array.getResourceId(R.styleable.SearchBar_mt_clearIconDrawable, R.drawable.ic_close_black_48dp);
        navIconTint = array.getColor(R.styleable.SearchBar_mt_navIconTint, ContextCompat.getColor(getContext(), R.color.searchBarNavIconTintColor));
        menuIconTint = array.getColor(R.styleable.SearchBar_mt_menuIconTint, ContextCompat.getColor(getContext(), R.color.searchBarMenuIconTintColor));
        ...
        navIconTintEnabled = array.getBoolean(R.styleable.SearchBar_mt_navIconUseTint, true);
        menuIconTintEnabled = array.getBoolean(R.styleable.SearchBar_mt_menuIconUseTint, true);
        ...
        borderlessRippleEnabled = array.getBoolean(R.styleable.SearchBar_mt_borderlessRippleEnabled, false);
